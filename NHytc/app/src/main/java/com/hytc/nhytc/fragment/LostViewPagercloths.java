 ...
 */
public class LostViewPagercloths extends Fragment {
    ...
    private void initwigit(View view) {
        listView = (ListView) view.findViewById(R.id.lv_lost_viewpager_clothes);
        abpull = (AbPullToRefreshView) view.findViewById(R.id.abpull_lost_clothes);
        progressBar = (ProgressBar) view.findViewById(R.id.pgb_lost_clothes);
