 ...
 */
public class ShuoshuoTopicActivityManager {
    ...
    public ShuoshuoTopicActivityManager(Activity activity,ProgressBar probar,ListView listView,AbPullToRefreshView abpull) {
    ...
    public void firstGetShuo(Integer topic){
        ...
        query.findObjects(activity, new FindListener<ShuoShuo>() {
            ...
            public void onError(int i, String s) {
                ...
                if(i != 9009){
                    Toast.makeText(activity, "访问失败，请检查网络连接！"+i, Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onHeadLoad(Integer topic){
    ...
    public void onFootLoad(Integer topic) {
